...
It is a hands-on, dopamine-replacement course where students solve 40 to 60 robotics, machine learning, sensors, actuators, and IoT challenges, then teach others their solutions.
...
My job is to put students into situations where they discover those abilities.
...
You are in one of the best places on the planet to raise funding.
...
But it is important to know where the money comes from.
...
In the middle when students reach problems they cannot solve.
...
If the results are positive, then we look for multi-year Global South funding.
...
A student should be able to ask an AI assistant for help, understand the answer, verify it, improve it, and eventually build their own tools.

That is why I believe students should experience local AI.

Why not load an LLM locally using an installable webpage called a PWA, a Progressive Web App?

A computer can become a private AI lab assistant without sending every question and every piece of data somewhere else.

Demo: Gemma 2B and 12B
...
Pre-engineers do not have to become engineers either.

They gain skills that work across many fields.

Either way, this course will challenge everyone.
...
The highest marks in the class, 90 to 100 percent, come from the culture of helping people.

Once the assignments are complete, students do Level 1 and Level 2 final projects.

Level 1 is a course pass.

Level 2 earns the higher mark.

Multiple people are expected to reach the top grade.

I am completely comfortable with ten students earning 100 percent.

It hurts no one and massively improves communication skills, confidence, and the tone of the classroom.
...
That balance between a large volume of hands-on work and real-world applications is the most powerful part of the course.

Many robotics programs begin with a kit.

Kits are useful for getting started, but they can create a dependency on one company's ecosystem.

When the hardware changes or disappears, the learning can disappear with it.
...
Students learn principles that transfer to new hardware, new industries, and new technologies.

The course is at github.com/hpssjellis/maker100-leaders-robotics.

It is open source, free, dynamic, and updated as issues are discovered.
...
The faster students finish, the more time they have for final projects.

And if they finish those, they start another challenge.

So far we have covered the pilot, student leadership, funding, local and cloud LLMs, and how students help each other while working independently.
...
If we can put robotics, machine learning, and AI tools into classrooms everywhere, students become creators.

Democratizing the ability to build technology is the beginning of technological independence.
...
You have heard about Maker100 Leaders Robotics.

A course that is difficult by design, but designed so students can grow technical skills, leadership skills, and the confidence to build the future.
